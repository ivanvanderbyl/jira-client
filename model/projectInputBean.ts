...
export class ProjectInputBean {
    ...
    */
    'description'?: string;
    /**
    * This parameter has been deprecated due to privacy changes. Use `leadAccountId` instead. See the [migration guide](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. The user name of the project lead. Either `lead` or `leadAccountId` must be set when creating a project. Optional when updating a project. Cannot be provided with `leadAccountId`.
    */
    'lead'?: string;
    /**
    ...
    */
    'avatarId'?: number;
    /**
    * The ID of the issue security scheme for the project, which enables you to control who can and cannot view issues. Use the [Get issue security schemes](#api-api-3-issuesecurityschemes-get) resource to get all issue security scheme IDs.
    */
    'issueSecurityScheme'?: number;
    /**
    * The ID of the permission scheme for the project. Use the [Get all permission schemes](#api-api-3-permissionscheme-get) resource to see a list of all permission scheme IDs.
    */
    'permissionScheme'?: number;
    /**
    * The ID of the notification scheme for the project. Use the [Get notification schemes](#api-api-3-notificationscheme-get) resource to get a list of notification scheme IDs.
    */
    'notificationScheme'?: number;
    /**
    * The ID of the project's category. A complete list of category IDs can be found using the [Get all project categories](#api-api-3-projectCategory-get) resource.
    */
    'categoryId'?: number;
...
export namespace ProjectInputBean {
    ...
    export enum ProjectTemplateKeyEnum {
        ...
        AtlassianJiraCoreProjectTemplatesjiraCoreSimplifiedTaskTrackingcomAtlassianJiraJiraIncidentManagementPluginimIncidentManagement = <any> 'com.atlassian.jira-core-project-templates:jira-core-simplified-task-trackingcom.atlassian.jira.jira-incident-management-plugin:im-incident-management'
    }
